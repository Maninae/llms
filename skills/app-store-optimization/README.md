...
cp -r app-store-optimization /path/to/your/project/.gemini/antigravity/skills/

# The agent will auto-load the skill when working in this project
```

#### User-Level Installation (Available in All Projects)
```bash
# Copy skill folder to user-level skills
cp -r app-store-optimization ~/.gemini/antigravity/skills/

# The agent will load this skill in all your projects
```
...
ls ~/.gemini/antigravity/skills/app-store-optimization/
...
```
Can you Can you research keywords for my fitness app? I'm targeting people who want home workouts, yoga, and meal planning. Analyze top competitors like Nike Training Club and Peloton.
```
...
```
Can you Optimize my app's metadata for both Apple App Store and Google Play Store:
- App: FitFlow
...
```
Can you Calculate my app's ASO score:
...
```
Can you I want to A/B test my app icon. My current conversion rate is 4.2%. How many visitors do I need and how long should I run the test?
```
...
```
Can you Analyze my last 500 reviews and tell me:
- Overall sentiment
...
```
Can you Generate a complete pre-launch checklist for both app stores. My launch date is March 15, 2026.
```
...
Developed by Antigravity Skills
